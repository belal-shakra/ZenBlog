        ...
        <div class="container">
            ...
            <div class="row mb-5">
                ...
                <div class="d-md-flex post-entry-2 half">
                    ...
                    <img src="{{asset('assets')}}/user/img/post-landscape-2.jpg" alt="" class="img-fluid">
                    </a>
                ...
                <div class="d-md-flex post-entry-2 half mt-5">
                    ...
                    <img src="{{asset('assets')}}/user/img/post-landscape-1.jpg" alt="" class="img-fluid">
                    </a>
      ...
      <div class="container">
        <div class="row justify-content-between align-items-lg-center">
          ...
          <div class="col-lg-6">
            <div class="row">
              <div class="col-6">
                <img src="{{asset('assets')}}/user/img/post-portrait-3.jpg" alt="" class="img-fluid mb-4">
              </div>
              <div class="col-6 mt-4">
                <img src="{{asset('assets')}}/user/img/post-portrait-4.jpg" alt="" class="img-fluid mb-4">
              </div>
            </div>
          </div>
        </div>
